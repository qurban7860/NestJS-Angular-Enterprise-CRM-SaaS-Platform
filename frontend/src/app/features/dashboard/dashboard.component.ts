    ...
    <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      @if (isLoading$ | async) {
        ...
        @if (stats$ | async; as stats) {
          <!-- Stats Grid -->
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div routerLink="/crm/deals" class="glass-panel p-6 hover:border-brand-primary/30 transition-colors cursor-pointer group">
            ...
            <div routerLink="/crm/contacts" class="glass-panel p-6 hover:border-brand-primary/30 transition-colors cursor-pointer group">
            ...
            <div routerLink="/tasks" class="glass-panel p-6 hover:border-brand-primary/30 transition-colors cursor-pointer group">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 glass-panel p-8 flex flex-col min-h-[400px]">
              <!-- Section Header & Buttons -->
              <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                  <h2 class="text-xl font-bold">Performance Overview</h2>
                  <p class="text-brand-secondary text-sm mt-1">Real-time CRM and Task metrics</p>
                </div>
                <div class="flex gap-3">
                   <button routerLink="/crm/deals" class="premium-button text-sm px-4 py-2">View CRM Reports</button>
                   <button routerLink="/tasks" class="secondary-button text-sm px-4 py-2 !border-white/10 !bg-white/5">Task Board</button>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
                <!-- CRM Pipeline Report -->
                <div class="space-y-4">
                  <h3 class="text-sm font-semibold uppercase tracking-wider text-brand-secondary mb-4 flex items-center gap-2">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-end gap-4 h-32 pt-4 border-b border-brand-border/50 pb-1">
                    <div class="flex-1 flex flex-col justify-end items-center group relative h-full">
                      <span class="absolute -top-6 text-xs font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow-md">12</span>
                      ...
                      <span class="text-[10px] mt-3 text-brand-secondary uppercase font-medium">To Do</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center group relative h-full">
                      <span class="absolute -top-6 text-xs font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow-md">8</span>
                      ...
                      <span class="text-[10px] mt-3 text-brand-secondary uppercase font-medium">Doing</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center group relative h-full">
                      <span class="absolute -top-6 text-xs font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow-md">24</span>
                      ...
                      <span class="text-[10px] mt-3 text-brand-secondary uppercase font-medium">Done</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Quick Actions -->
              <div class="mt-20 pt-8 border-t border-brand-border/30 grid grid-cols-1 sm:grid-cols-3 gap-4">
                 <div class="bg-white/5 rounded-xl p-4 flex items-center gap-4 hover:bg-white/10 transition-colors cursor-pointer group" routerLink="/crm/contacts">
                   <div class="w-10 h-10 rounded-full bg-indigo-500/10 text-indigo-400 flex items-center justify-center group-hover:bg-indigo-500/20 transition-colors">
                   ...
                   <div>
                     ...
                     <p class="text-xs text-brand-secondary">Grow your network</p>
                   </div>
                 </div>
                 <div class="bg-white/5 rounded-xl p-4 flex items-center gap-4 hover:bg-white/10 transition-colors cursor-pointer group" routerLink="/crm/deals">
                   <div class="w-10 h-10 rounded-full bg-emerald-500/10 text-emerald-400 flex items-center justify-center group-hover:bg-emerald-500/20 transition-colors">
                   ...
                   <div>
                     ...
                     <p class="text-xs text-brand-secondary">Expand pipeline</p>
                   </div>
                 </div>
                 <div class="bg-white/5 rounded-xl p-4 flex items-center gap-4 hover:bg-white/10 transition-colors cursor-pointer group" routerLink="/tasks">
                   <div class="w-10 h-10 rounded-full bg-amber-500/10 text-amber-400 flex items-center justify-center group-hover:bg-amber-500/20 transition-colors">
                   ...
                   <div>
                     ...
                     <p class="text-xs text-brand-secondary">Assign work</p>
                   </div>
                 </div>
              </div>
            </div>
            ...
            <div class="glass-panel p-6 flex flex-col">
              ...
              <button routerLink="/system/audit-logs" class="w-full mt-8 py-2 text-sm text-brand-secondary hover:text-white transition-colors border border-brand-border rounded-lg hover:bg-white/5">View All Activity</button>
            </div>
          </div>
        }
      }
